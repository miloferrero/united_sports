...
print ('\nHola Agustín!!👋')
print('\nTu primer entrenamiento es dentro de 7 días y quería compartirte el día a día:\n')
df = conexion(9)
tabla = tabulate(df, headers='keys', tablefmt='pretty', showindex=False, stralign="left") 
print(tabla)
print('\nSi queres información mas detallada podes entrar en el siguiente link: https://shorturl.at/ipqE6.')
print('\nUn día antes del primer entrenamiento voy contactarme con vos para darte detalles del mismo.')
print('\nHasta luego 👋👋👋\n')
sys.exit()
