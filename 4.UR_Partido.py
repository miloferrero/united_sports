...
def procesar_preguntas(df):
    ...
    for _, row in df.iterrows():
        ...
        write_to_cell(spreadsheet, sheet_number=13, row=i+1 , col=4, value=respuesta)
#df = conexion(11)
#print(df)
...
print ('\nHola Agustín!!👋')
print('\nEl partido de ayer vs Jockey salió 20 a 19, ganamos! 😄😄😄\n')
print('\nEntra al siguiente link de BDUAR para poder ver el resumen del partido.\n')
print('\nResponde las siguientes preguntas con una calificaciión del 1 al 5:')
df = conexion(13)
procesar_preguntas(df)
print("\nEstas fueron tus respuestas:")
columnas_seleccionadas = df[["CATEGORIA", "PREGUNTA", "RESPUESTA"]]
